...
self.addEventListener("fetch", (event) => {
  ...
  // Ignorar requests de extensiones de Chrome y esquemas no-http
        ...
        return cache.match(request).then((cachedResponse) => {
          ...
          return fetch(request)
            ...
            .catch(() => {
              ...
              return new Response(
                '<svg width="200" height="300" xmlns="http://www.w3.org/2000/svg"><rect width="100%" height="100%" fill="#1f2937"/><text x="50%" y="50%" fill="#9ca3af" text-anchor="middle" font-size="16">No disponible</text></svg>',
